    ...
    if os.path.isfile(filename):
        with open(filename, 'r') as f:
            for line in f.readlines():
                ...
                linelist[5] = float(linelist[5]) - float(linelist[3])
                score = 1
                # if view == 'View1' and chu == 1:
                #     linelist[2] = float(linelist[2]) * 1920 / 3640
                #     linelist[3] = float(linelist[3]) * 1080 / 2048
                #     linelist[4] = float(linelist[4]) * 1920 / 3640
                #     linelist[5] = float(linelist[5]) * 1080 / 2048
