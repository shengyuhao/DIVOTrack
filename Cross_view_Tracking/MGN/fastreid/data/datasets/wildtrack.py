...
class WILDTRACK(ImageDataset):
    ...
    def __init__(self, root='datasets', wildtrack=False, **kwargs):
        ...
        gallery = lambda: self.process_dir(self.gallery_dir, is_train=False) + \
                          (self.process_dir(self.extra_gallery_dir, is_train=False) if self.wildtrack else [])
