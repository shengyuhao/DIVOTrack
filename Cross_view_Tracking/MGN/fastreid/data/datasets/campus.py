...
class CAMPUS(ImageDataset):
    ...
    def __init__(self, root='datasets', campus=False, **kwargs):
        ...
        gallery = lambda: self.process_dir(self.gallery_dir, is_train=False) + \
                          (self.process_dir(self.extra_gallery_dir, is_train=False) if self.campus else [])

        super(CAMPUS, self).__init__(train, query, gallery, **kwargs)
