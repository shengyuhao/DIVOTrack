...
def main():
    ...
    cfg.model.load_weights = '/home/syh/shengyuhao/tracking_wo_bnw/output/tracktor/reid/market1501/model/model-last.pth.tar'
    if check_isfile(cfg.model.load_weights):
