...
class Evaluator(object):
	...
	def run(self, benchmark_name = None ,  gt_dir = None, res_dir = None, save_pkl = None, eval_mode = "train", seq_file = None):
		"""
		Params
		-----
		...
		#self.sequences = np.genfromtxt(self.seq_file, dtype='str', skip_header=True)
		self.sequences = np.loadtxt(self.seq_file, dtype='str')
