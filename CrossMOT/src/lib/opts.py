...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            "--baseline", type=int, default=0, help="default 0, 1 for baseline"
        )
        self.parser.add_argument(
            "--baseline_view",
            type=int,
        ...
        # system
        self.parser.add_argument(
            "--gpus", default="2, 3", help="-1 for CPU, use comma for multiple gpus"
        )
        self.parser.add_argument(
            "--num_workers",
            type=int,
        ...
        self.parser.add_argument(
            "--test_mvmhat", action="store_true", help="Track MvMHAT dataset"
        )
        self.parser.add_argument(
            "--test_mvmhat_campus", action="store_true", help="Track CAMPUS dataset"
        )
        self.parser.add_argument(
            "--test_wildtrack", action="store_true", help="Track Wildtrack dataset"
        )
        self.parser.add_argument(
            "--test_epfl", action="store_true", help="Track EPFL dataset"
        )
        ...
        self.parser.add_argument(
            "--exp_name", type=str, default="test", help="The test name of experiment"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--reid_dim", type=int, default=512, help="feature dim for reid"
        )
        self.parser.add_argument(
